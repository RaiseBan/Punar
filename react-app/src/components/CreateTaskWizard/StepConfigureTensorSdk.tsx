...
export default function StepConfigureTensorSdk({
  ...
  const validateField = useCallback(
    (field: string, value: unknown): string | null => {
      switch (field) {
        case 'taskName':
          const nameResult = validateNonEmptyString(String(value), 'Task name');
          return nameResult.isValid ? null : nameResult.error || 'Required';

        case 'collectionId':
          const collResult = validateTensorCollection(String(value));
        ...
        case 'thresholdPrice':
          ...
          const priceResult = validatePositiveNumber(String(value));
