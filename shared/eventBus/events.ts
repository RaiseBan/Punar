...
export const TELEGRAM_EVENTS = {
  BOT_CONFIGURED: 'telegram:bot-configured',
...
export interface TelegramBotConfiguredEvent {
  token: string;
  chatCount: number;
  timestamp: number;
}

export interface TelegramBotStartedEvent {
  timestamp: number;
}

export interface TelegramBotStoppedEvent {
  timestamp: number;
}
...
export type EventType =
    ...
    | typeof TELEGRAM_EVENTS[keyof typeof TELEGRAM_EVENTS];
...
export type EventData =
    ...
    | TelegramBotConfiguredEvent
    | TelegramBotStartedEvent
    | TelegramBotStoppedEvent
